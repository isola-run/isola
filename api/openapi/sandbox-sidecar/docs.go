// Package sandbox_sidecar Code generated by swaggo/swag. DO NOT EDIT
package sandbox_sidecar
...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_sandbox-sidecar_handlers.FilesystemWriteResponse"
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "internal_sandbox-sidecar_handlers.FilesystemWriteResponse": {
            "type": "object",
            "properties": {
                "absolute_path": {
                    "type": "string",
