...
// Re-export condition types and reason constants from the CRD package so that
// existing in-package references (controller + tests) continue to compile
// without a qualified prefix.
const (
