	...
	tests := []struct {
		...
		},
		{
			...
			expectedExcept: []string{
				...
				"192.168.0.0/16", "198.18.0.0/15", "240.0.0.0/4", "34.118.224.0/20", "224.0.0.0/4",
				"192.0.0.0/24", "192.0.2.0/24", "192.88.99.0/24", "198.51.100.0/24",
				"203.0.113.0/24", "168.63.129.16/32",
			},
		},
		{
		...
		},
		{
			...
			expectError: false,
			expectedExcept: []string{
				"fc00::/7", "fe80::/10", "2600:2d00:0:4::/64", "ff00::/8",
				"::ffff:0.0.0.0/96", "64:ff9b:1::/48", "100::/64", "100:0:0:1::/64",
		...
		},
		{
			...
			allowed:        "2607:f8b0::/32",
			expectError:    false,
			expectedExcept: nil,
		},
		{
			name:          "2001:db8::/32 equals blocked - error",
			allowed:       "2001:db8::/32",
			expectError:   true,
			errorContains: "equals blocked range",
		},
		{
			name:          "documentation subnet inside blocked",
			allowed:       "2001:db8:1::/48",
			expectError:   true,
			errorContains: "inside blocked range 2001:db8::/32",
		},
		{
