	...
	tests := []struct {
		...
		},
		{
			...
			expectedExcept: []string{
				...
				"34.118.224.0/20", "199.36.153.4/30", "199.36.153.8/30",
				"34.126.0.0/18", "168.63.129.16/32",
			},
		},
		{
		...
		},
		{
			...
			expectedExcept: []string{
				...
				"198.18.0.0/15", "198.51.100.0/24", "203.0.113.0/24",
				"224.0.0.0/4", "240.0.0.0/4",
				"199.36.153.4/30", "199.36.153.8/30", "168.63.129.16/32",
			},
		},
		{
			...
			expectError: false,
			expectedExcept: []string{
				"::/128", "::1/128", "::ffff:0.0.0.0/96",
				"64:ff9b:1::/48", "100::/64", "100:0:0:1::/64",
				"2001:2::/48", "2001:db8::/32",
				"3fff::/20", "5f00::/16",
				"fc00::/7", "fe80::/10", "ff00::/8",
				"2001::/32", "2001:10::/28", "2002::/16",
				"2001:4860:8040::/42",
				"2600:2d00:0:2::/64", "2600:2d00:0:3::/64", "2600:2d00:0:4::/64",
				"2600:2d00:2:1000::/56", "2600:2d00:2:2000::/56",
			},
		},
		{
		...
		{
			name:          "2001:db8::/32 equals blocked IPv6 - error",
			allowed:       "2001:db8::/32",
			expectError:   true,
			errorContains: "equals blocked range",
		},
