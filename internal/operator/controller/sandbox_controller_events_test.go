	...
	Context("Event Recording", func() {
		...
		It("should record RootfsSnapshotCreated event", func() {
			...
			createSandbox(ctx, sandboxName, func(s *sandboxv1alpha1.Sandbox) {
				...
				s.Spec.TerminationPolicy = &sandboxv1alpha1.TerminationPolicy{Type: sandboxv1alpha1.TerminationTypeSnapshotRootfs, SnapshotRootfs: &sandboxv1alpha1.SnapshotRootfsTermination{SnapshotName: "test-snapshot"}}
			})
			defer deleteSandbox(ctx, sandboxName)
