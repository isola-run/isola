	...
	Context("Event Recording", func() {
		...
		It("should record RootfsSnapshotCreated event", func() {
			...
			createSandbox(ctx, sandboxName, func(s *sandboxv1alpha1.Sandbox) {
				...
				s.Spec.ShutdownPolicy = &sandboxv1alpha1.ShutdownPolicy{Strategy: sandboxv1alpha1.ShutdownStrategySnapshotRootfs, SnapshotRootfs: &sandboxv1alpha1.SnapshotRootfsConfig{}}
